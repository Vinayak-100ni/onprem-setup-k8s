...
Apply the latest official components:
```
kubectl apply -f https://github.com/kubernetes-sigs/metrics-server/releases/latest/download/components.yaml
```
#### Patch Metrics Server for On-Prem / Self-Signed Kubelet
In kubeadm-based on-prem clusters, metrics-server often fails TLS verification.
Edit deployment:
```
...
```
You should see:
_metrics-server-xxxxx   Running_
#### Verify Metrics API
Run:
```
kubectl top nodes
